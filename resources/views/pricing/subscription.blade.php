    ...
    <main class="container mx-auto px-6 py-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center">
            ...
            <div class="bg-white border border-slate-200 rounded-[2.5rem] p-10 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 relative group">
                ...
                <a href="{{ route('planes.starter') }}" class="block w-full py-4 rounded-xl border-2 border-slate-300 text-slate-600 font-bold text-xs uppercase tracking-widest text-center hover:border-slate-900 hover:text-slate-900 transition-colors">
                    Comenzar ahora
                </a>
            ...
            <div class=" bg-white border border-slate-200 rounded-[2.5rem] p-10 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                ...
                <a href="{{ route('planes.senior') }}" class="block w-full py-4 rounded-xl border-2 border-slate-300 text-slate-600 font-bold text-xs uppercase tracking-widest text-center hover:border-emerald-500 hover:text-emerald-600 transition-colors">
                    Contactar Ventas
                </a>
